/*
  # Create Featured Deals Table

  1. New Tables
    - `featured_deals`
      - `deal_id` (serial, primary key)
      - `image` (text, required - image URL/path)
      - `title` (varchar(255), required - product name)
      - `subtitle` (varchar(500), optional - brief description)
  ...
  2. Security
    ...
    - Add policy for public read access to active deals
    - Add policy for authenticated users to manage deals

  3. Indexes
    - Index on `is_active` for filtering active deals
    - Index on `created_date` for sorting by newest deals
    - Index on `deal_price` for price-based sorting

  4. Sample Data
    - Insert realistic Indian product deals with proper pricing
*/
...
CREATE TABLE IF NOT EXISTS featured_deals (
  ...
  CONSTRAINT valid_deal_price CHECK (deal_price < original_price)
);
...
-- Insert sample featured deals data
INSERT INTO featured_deals (image, title, subtitle, original_price, deal_price, buy_now_link) VALUES
(
  'https://images.pexels.com/photos/788946/pexels-photo-788946.jpeg?auto=compress&cs=tinysrgb&w=400',
  'Samsung Galaxy Smartphone',
  'Latest Android smartphone with 128GB storage and triple camera setup',
  25999.00,
  18999.00,
  'https://www.amazon.in/dp/example1'
),
(
  'https://images.pexels.com/photos/205926/pexels-photo-205926.jpeg?auto=compress&cs=tinysrgb&w=400',
  'Apple MacBook Air M2',
  'Ultra-thin laptop with M2 chip, 8GB RAM, and 256GB SSD storage',
  119900.00,
  89999.00,
  'https://www.flipkart.com/example2'
),
(
  ...
  29990.00,
  21990.00,
  'https://www.amazon.in/dp/example3'
),
(
  'https://images.pexels.com/photos/437037/pexels-photo-437037.jpeg?auto=compress&cs=tinysrgb&w=400',
  'Apple Watch Series 9',
  'Advanced fitness tracking with ECG and blood oxygen monitoring',
  45900.00,
  38999.00,
  'https://www.apple.com/in/example4'
),
(
  ...
  'Portable waterproof speaker with powerful bass and 20-hour playtime',
  12999.00,
  8999.00,
  'https://www.flipkart.com/example5'
),
(
  ...
  8995.00,
  6499.00,
  'https://www.amazon.in/dp/example6'
),
(
  'https://images.pexels.com/photos/324028/pexels-photo-324028.jpeg?auto=compress&cs=tinysrgb&w=400',
  'Philips Air Fryer HD9252',
  'Healthy cooking with rapid air technology, 4.1L capacity for family meals',
  12995.00,
  9999.00,
  'https://www.flipkart.com/example7'
),
(
  'https://images.pexels.com/photos/2529148/pexels-photo-2529148.jpeg?auto=compress&cs=tinysrgb&w=400',
  'Nike Air Max 270 Sneakers',
  'Comfortable running shoes with Max Air cushioning and breathable mesh',
  12995.00,
  8999.00,
  'https://www.nike.com/in/example8'
),
(
  'https://images.pexels.com/photos/1040945/pexels-photo-1040945.jpeg?auto=compress&cs=tinysrgb&w=400',
  'Levi\'s 511 Slim Fit Jeans',
  'Classic slim-fit denim jeans in dark wash, comfortable stretch fabric',
  3999.00,
  2499.00,
  'https://www.levis.in/example9'
),
(
  ...
  'Premium non-slip yoga mat with carrying strap and alignment guides',
  2999.00,
  1899.00,
  'https://www.amazon.in/dp/example10'
);